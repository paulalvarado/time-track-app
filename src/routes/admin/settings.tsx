...
const sections = [
  {
    key: "profile",
    title: "Perfil",
    desc: "Actualiza tu nombre y cambia tu contraseña.",
  ...
  },
  {
    key: "odoo",
    title: "Conexión Odoo",
    desc: "Configura tu instancia de Odoo para sincronizar proyectos.",
    ...
    to: "/admin/settings/odoo",
  },
  {
    key: "ai",
    title: "IA",
    desc: "Configura proveedores de IA (OpenAI, Anthropic, Gemini) para transcripción.",
  ...
  return (
    <div className="mx-auto max-w-[1200px] px-6 py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {sections.map((s) => (
          <Link key={s.key} to={s.to} className="block no-underline group h-full">
