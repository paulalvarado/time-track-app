          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <div className="flex rounded-[6px] border border-border bg-page p-0.5">
                ...
                <a href="/forms" className="inline-flex h-[28px] items-center rounded-[4px] bg-card px-3 text-[13px] font-medium leading-[20px] text-text-primary no-underline border border-border">
                  Formularios
                </a>
                <a href="/dialogs" className="inline-flex h-[28px] items-center rounded-[4px] px-3 text-[13px] font-medium leading-[20px] text-text-secondary no-underline hover:text-text-primary">
                  Dialogs
                </a>
              </div>
              <a href="/" className="inline-flex h-[28px] items-center rounded-[6px] bg-[#171717] px-2 text-[14px] font-medium leading-[20px] text-[#ffffff] no-underline">
                Volver
              </a>
            </div>
          </div>
